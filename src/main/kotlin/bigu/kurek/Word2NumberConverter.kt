...
enum class Word2NumberConverter(
    ...
    V6(
        mapOf(
            ...
            'b' to '8', 'h' to '8', 'x' to '8', 'z' to '8', // 8=B,H,X,Z
    ...
    V8(
        mapOf(
            'l' to '1', 't' to '1', // 1=L,T
            'n' to '2', 'ń' to '2', 'v' to '2', 'z' to '2',// 2=N,Ń,V,Z
            'm' to '3', 'w' to '3', // 3=M,W
            'r' to '4',             // 4=R,RZ
            's' to '5', 'ś' to '5', // 5=S,Ś,SZ
            'g' to '6', 'j' to '6', 'ź' to '6', 'ż' to '6', // 6=G,J,Ż,Ź
            'f' to '7', 'k' to '7', 'ł' to '7', // 7=F,K,Ł
            'b' to '8', 'h' to '8', 'x' to '8', // 8=B,H,X
            'p' to '9', // 9=P,D,DZ,DŻ,DŹ
            'c' to '0', 'ć' to '0', 'q' to '0', 'd' to '9' // 0=C,Ć,Q,CH,CZ
        ),
        listOf(
            { s -> s.lowercase() },
            { s -> s.replace("rz", "r") },
